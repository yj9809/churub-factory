...
try {
    ...
    # Probe an existing lock without deleting it or closing the user's Editor.
    ...
    # Start-Process joins ArgumentList; quote each value for Windows paths with spaces.
    ...
    # Let XML read its UTF-8 declaration (Windows PowerShell defaults to ANSI).
